...
<!--        <el-table-column align="left" label="群名称" prop="name" width="120" />-->
        <el-table-column align="left" label="用户昵称" prop="nickName" width="120" />
<!--        <el-table-column align="left" label="消息" prop="msg" width="120" />-->
<!--        <el-table-column align="left" label="selfId字段" prop="selfId" width="120" />-->
<!--        <el-table-column align="left" label="wechatId字段" prop="wechatId" width="120" />-->
...
<!--        <el-table-column align="left" label="groupId字段" prop="groupId" width="120" />-->
        <el-table-column align="left" label="是否需要统计" prop="needStatistics" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.needStatistics) }}</template>
        </el-table-column>
<!--        <el-table-column align="left" label="是否采集" prop="isCollocet" width="120">-->
<!--            <template #default="scope">{{ formatBoolean(scope.row.isCollocet) }}</template>-->
<!--        </el-table-column>-->
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateGroupFunc(scope.row)">变更</el-button>
...
<!--        </el-form-item>-->
        ...
        <el-form-item label="是否需要统计:"  prop="needStatistics" >
          <el-switch v-model="formData.needStatistics" active-color="#13ce66" inactive-color="#ff4949" active-text="是" inactive-text="否" clearable ></el-switch>
        </el-form-item>
<!--        <el-form-item label="是否采集:"  prop="isCollocet" >-->
<!--          <el-switch v-model="formData.isCollocet" active-color="#13ce66" inactive-color="#ff4949" active-text="是" inactive-text="否" clearable ></el-switch>-->
<!--        </el-form-item>-->
      </el-form>
      <template #footer>
...
const onSubmit = () => {
  page.value = 1
  pageSize.value = 10
  if (searchInfo.value.needStatistics === ""){
      searchInfo.value.needStatistics=null
  }
  if (searchInfo.value.isCollocet === ""){
      searchInfo.value.isCollocet=null
  }
  getTableData()
}
...
const updateGroupFunc = async(row) => {
    ...
    type.value = 'update'
    if (res.code === 0) {
        formData.value = res.data.regroup
