    ...
    "paths": {
        ...
        "/mdjTask/createMdjTask": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建MdjTask",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ai.MdjTask"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "discord": {
                    "$ref": "#/definitions/config.Discord"
                },
                "email": {
